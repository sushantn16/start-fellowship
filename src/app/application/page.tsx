                ...
                <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input id="first-name" placeholder="First name" required name="firstName" value={formData.user.firstName} onChange={handleChange} />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="last-name">Last name</Label>
                            <Input id="last-name" placeholder="Last name" required name="lastName" value={formData.user.lastName} onChange={handleChange} />
                        </div>
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="email">Email</Label>
                        <Input id="email" placeholder="Email" required type="email" name="email" value={formData.user.email} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="phone">Phone number</Label>
                        <Input id="phone" placeholder="Phone number" required type="tel" name="phone" value={formData.user.phone} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="dob">Date of birth</Label>
                        <Input id="dob" required type="date" name="dob" value={formData.user.dob} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="address">Address</Label>
                        <Input id="address" placeholder="Address" required name="address" value={formData.user.address} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="city">City</Label>
                        <Input id="city" placeholder="City" required name="city" value={formData.user.city} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="country">Country</Label>
                        <Input id="country" placeholder="Country" required name="country" value={formData.user.country} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="nationality">Nationality</Label>
                        <Input id="nationality" placeholder="Nationality" required name="nationality" value={formData.user.nationality} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="residence">Country of residence</Label>
                        <Input id="residence" placeholder="Country of residence" required name="residence" value={formData.user.residence} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="id-number" placeholder="ID number" required name="idNumber" value={formData.user.id.idNumber} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="id-issue">ID issue date</Label>
                        <Input id="id-issue" required type="date" name="idIssue" value={formData.user.id.idIssue} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="id-expiry">ID expiry date</Label>
                        <Input id="id-expiry" required type="date" name="idExpiry" value={formData.user.id.idExpiry} onChange={handleChange} />
                    </div>
                </div>
                <div className="space-y-4">
                    <div className="space-y-2">
                        <Label htmlFor="startup-name">Startup name</Label>
                        <Input id="startup-name" placeholder="Startup name" required name="startupName" value={formData.startup.name} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="startup-website">Startup website</Label>
                        <Input id="startup-website" placeholder="Startup website" name="startupWebsite" value={formData.startup.website} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="startup-founding">Date of startup founding</Label>
                        <Input id="startup-founding" required type="date" name="startupFounding" value={formData.startup.founding} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="startup-description">Brief description of your startup</Label>
                        <Textarea id="startup-description" placeholder="Description" required name="startupDescription" value={formData.startup.description} onChange={handleChange} />
                    </div>
                    <div className="space-y-2">
